  ...
  return (
    ...
    >
      ...
      <p className="text-xl font-montserrat text-coral-red">Our Summer Colletion</p>
        <h1 className="mt-11 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82] font-bold">
        ...
        <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
          ...
          <div className="flex -left-[10%] sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6">
          {shoes.map((shoe) => (
            <div key={shoe}>
              <ShoeCard
              imgURL={shoe}
